...
/**
 * openclaw {fleet} 子命令的类型化选项：动作枚举 + 可选操作数 + 附加参数，
 * 按文档化子命令树生成参数。
 *
 * @author <a href="https://github.com/loong10k">Loong Wan</a>
 * @since 1.0.0
 */
public final class FleetOptions implements CliSubArgs {
    ...
    private FleetOptions(Builder builder) {
    ...
    public static final class Builder {
         ...
         * @return 选项实例
         */
        public FleetOptions build() {
            return new FleetOptions(this);
        }
    }
}
