...
/**
 * openclaw {workboard} 子命令的类型化选项：动作枚举 + 可选操作数 + 附加参数，
 * 按文档化子命令树生成参数。
 *
 * @author <a href="https://github.com/loong10k">Loong Wan</a>
 * @since 1.0.0
 */
public final class WorkboardOptions implements CliSubArgs {
    ...
    private WorkboardOptions(Builder builder) {
    ...
    public static final class Builder {
        ...
        /**
         * 追加一组附加参数（create 等动作的自由参数）。
         *
         * @param values 参数值列表
         * @return 当前构建器
         */
        public Builder arguments(java.util.List<String> values) {
         ...
         * @return 选项实例
         */
        public WorkboardOptions build() {
            return new WorkboardOptions(this);
        }
    }
}
